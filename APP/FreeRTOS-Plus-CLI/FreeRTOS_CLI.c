...
BaseType_t FreeRTOS_CLIProcessCommand( const char * const pcCommandInput, char * pcWriteBuffer, size_t xWriteBufferLen  )
{
	...
	const static char log1[] = "Incorrect command parameter(s).  Enter \"help\" to view a list of available commands.\r\n";
	const static char log2[] = "Command not recognised.  Enter 'help' to view a list of available commands.\r\n";
